...
namespace RedBeanPHP {
    ...
    class OODBBean implements \IteratorAggregate,\ArrayAccess,\Countable,Jsonable
    {
         ...
         * two persons: a hod and a student. The person beans have been aliased in this
         * case, so to the project has a teacher_id pointing to a person, and a student_id
         * also pointing to a person. Given a project, we obtain the hod like this:
         *
         * <code>
         * $project->fetchAs('person')->hod;
         * </code>
         *
         * Now, if we want all projects of a hod we cant say:
         *
         * <code>
         * $hod->ownProject
         * </code>
         *
         * because the $hod is a bean of type 'person' and no project has been
         * assigned to a person. Instead we use the alias() method like this:
         *
         * <code>
         * $hod->alias('hod')->ownProject
         * </code>
         *
...
namespace RedBeanPHP {
     ...
     * database as well as providing other crud.php functions. This class acts as a
     * object database.
     *
...
namespace RedBeanPHP {
    ...
    class SimpleModelHelper implements Observer
    {
         ...
         * crud.php events. If a crud.php event occurs it will send a signal to the model
         * that belongs to the crud.php bean and this model will take over control from
