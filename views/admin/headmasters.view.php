  ...
  <div class="container-fluid content-top-gap">
    ...
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb my-breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">All Headmasters</li>
      </ol>
    </nav>
      ...
      <div class="card">
          <div class="card-body">
              <table class="table table-bordered table-hover">
                  ...
                  <tbody>
                    <?php foreach ($ctx['headmasters'] as $headmaster): ?>
                            <tr>
                                <td><?= $headmaster['h_name'] ?></td>
                                <td><?= $headmaster['h_phone'] ?></td>
                                <td><?= $headmaster['institution']['i_name'] ?></td>
                                <td class="d-flex justify-content-center">
                                  <form method="POST">
                                      <input type="hidden" value="<?= $headmaster['id'] ?>" name="iid">
